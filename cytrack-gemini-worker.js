...
// No credit card required for either Cloudflare or Google AI Studio
...
try {
  ...
  // Body shape expected: { prompt: "...", systemPrompt: "...", model?: "gemini-2.5-flash" }
  const model = body.model || 'gemini-2.5-flash';

  // Build Gemini's expected request format
  const geminiRequest = {
    contents: [
  ...
  // Extract just the text from Gemini's response and return a clean shape
  let answerText = '';
